...
<title>Sprinks WiFi Config</title>
...
<body>
<div id='page_update'>
<div><h3>Sprinks AP-mode Firmware Update</h3></div>
<div>
...
<p style='font-weight:normal;'>&copy; OpenSprinkler (<a href='https://kubee.ga' target='_blank' style='text-decoration:none'>www.kubee.ga</a>)</p>
</div>  
</div>
<script>
function id(s) {return document.getElementById(s);}
